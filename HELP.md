...
* The original package name 'com.example.supabase-native-demo' is invalid and this project uses 'com.example.supabase_native_demo' instead.
...
```
$ docker run --rm -p 8080:8080 supabase-native-demo:0.0.1-SNAPSHOT
```
